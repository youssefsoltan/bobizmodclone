...
let human = await fetch(`https://api.lolhuman.xyz/api/instagram?apikey=85faf717d0545d14074659ad&url=${args[0]}`)
...
await await m.reply(`اذا لم يشتغل معك هذا الامر جرب احد هذه الاوامر متبوعة برابط الفيديو (${usedPrefix}ig, ${usedPrefix}ig2, ${usedPrefix}ig3)*`)
}}
