...
auth: state,
browser: ['noureddine_ouafy','Safari','9.7.0']
}
...
console.log(chalk.yellow('🚩ㅤQR صالح للفحص في ستين ثانية فقط و يجب عليك استعمال كود اخر و اعادة الفحص مجددا لذا كن سريعا في الفحص يا عزيزي بوبيز يحبكم .'))
}
if (connection == 'open') {
...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ مرحبا بك في مجموعتنا /𝙰* \n*║*\n*╟❧ بوبيز يرحب بك يا عزيزي:*\n\n@desc\n\n*║*\n*╟❧ https:// instagram.com/noureddine_ouafy!!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ الى اللقاء يا عزيزي https:// instagram.com/noureddine_ouafy👋🏻* \n*╚══════════════*'
...
let bio = `🤖𝖡𝖮𝖡𝖨𝖹𝖡𝖮𝖳 كن في الدنيا كأنك غريب أول كعابر سبيل (استغفر الله تُؤَجر ونُؤْجر عليها ♥`
