...
auth: state,
browser: ['YoUsSef Al SoLtAn','Safari','9.7.0']
}
...
console.log(chalk.yellow('🚩ㅤQR صالح للفحص في ستين ثانية فقط و يجب عليك استعمال كود اخر و اعادة الفحص مجددا لذا كن سريعا في الفحص يا عزيزي بوت السلطان يحبكم .'))
}
if (connection == 'open') {
...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ مرحبا بك في مجموعتنا /𝙰* \n*║*\n*╟❧ بوت السلطان يرحب بك يا عزيزي:*\n\n@desc\n\n*║*\n*╟❧ https:// instagram.com/1y._.o2!!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ الى اللقاء يا عزيزي https:// instagram.com/1y._.o2👋🏻* \n*╚══════════════*'
...
let bio = `اهلا بك ☑, انا بوت واتساب لمعرفه الاوامر اكتب menu.  مطوري:@1y._.o2`
